...
class FavoritesController(
    ...
    fun favorites(
        ...
        @RequestBody createFavoritesRequest: CreateFavoritesRequest
    ...
    //    즐겨찾기 목록
    @GetMapping
    fun viewAllFavoritesList(@AuthenticationPrincipal member: User): ResponseEntity<List<FavoritesResponse>> {
        val memberId = member.username.toLong()
        return ResponseEntity
            .status(HttpStatus.OK)
            .body(favoritesService.viewAllFavoritesList(memberId))
    }
}